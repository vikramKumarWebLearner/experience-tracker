                                ...
                                if(isset($data)){
                                    ...
                                    echo '<p>Available Budget : '. $budget.'    ₹</p>';
                                        ...
                                        if($budgetLeftPer >= 100){
                                            $budgetLeftPer = 100;
                                            $review="You have already crossed your Budget Limit by  ₹  ".($expense-$monthlyBudget);
                                        }

                                    echo '<div class="progress-container">
                                            <div class="budget-progress" id="budgetProgress"></div>
                                        </div><script>
                                        document.getElementById("budgetProgress").style.width ="'. $budgetLeftPer.'%";</script>
